...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/openalex-research-rag",
  "readmeUrl": "https://github.com/Justin21523/openalex-research-rag#readme",
  ...
  "architecture": "This case study is generated from the portfolio catalog pipeline using README, Git metadata, package/build configuration, and media signals. The final architecture narrative still needs source-level review. Current detected technology signals include: Python, FastAPI, React, Vite, Tailwind CSS, DuckDB, ChromaDB, BM25, sentence-transformers, RAG, llama.cpp, Recharts, Playwright.",
  ...
  "features": [
    "Detected technical signals: Python, FastAPI, React, Vite, Tailwind CSS, DuckDB, ChromaDB, BM25, sentence-transformers, RAG, llama",
    "cpp, Recharts, Playwright,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
    "I built a FastAPI backend over DuckDB + ChromaDB + BM25 with a hybrid (RRF) retriever and a citation-grounded RAG pipeline (llama",
    "cpp, with extractive fallback), then a React frontend with rich Recharts/framer-motion visualizations, an auto-starting guided tour, a 'Data Story' that animates a query through 7 pipeline stages with per-step explanations, and full i18n",
    "I verified every feature with a Playwright capture pipeline (screenshots + demo video)"
  ],
  "metrics": [
    {
      "label": "Demo Modules",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: Python, FastAPI, React, Vite, Tailwind CSS, DuckDB, ChromaDB, BM25, sentence-transformers, RAG, llama",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
      "id": "flow-02",
      "name": "cpp, Recharts, Playwright,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Review",
      "owner": "Data"
    },
    {
      "id": "flow-03",
      "name": "I built a FastAPI backend over DuckDB + ChromaDB + BM25 with a hybrid (RRF) retriever and a citation-grounded RAG pipeline (llama",
      "status": "Queued",
      "owner": "Automation"
    },
    {
      "id": "flow-04",
      "name": "cpp, with extractive fallback), then a React frontend with rich Recharts/framer-motion visualizations, an auto-starting guided tour, a 'Data Story' that animates a query through 7 pipeline stages with per-step explanations, and full i18n",
      "status": "Ready",
      "owner": "Product"
    },
    {
      "id": "flow-05",
      "name": "I verified every feature with a Playwright capture pipeline (screenshots + demo video)",
      "status": "Review",
      "owner": "Quality"
    }
  ]
